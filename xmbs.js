 ...
 */
 ...
 function addStep1(timeout = 3 * 1000) {
     return new Promise((resolve) => {
         let url = {
             url: `https://service-5qmilk03-1251019219.sh.apigw.tencentcs.com/release/zge?user=${bs[0]}&password=${bs[1]}&step=${bs[2]}`,    
             headers: { 
                "Host": "service-5qmilk03-1251019219.sh.apigw.tencentcs.com",
